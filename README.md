...
| `resources.html` | ⚠️ Internal ops notes (see privacy note below) |
...
## ⚠️ Privacy notes
- **`resources.html` is only client-side password-gated.** On a *public* GitHub repo / GitHub Pages,
  anyone can read its source (view-source defeats the gate). If you keep it here, **make the repo private**,
  or delete `resources.html` before publishing.
